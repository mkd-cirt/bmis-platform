...
function essentialObl(isPublic: boolean): string[] {
  return [
    ...
    ...(isPublic ? [] : ["Именување офицер за сајбер безбедност — ЗБМИС Чл.13"]),
    "Обука на раководствениот орган за сајбер безбедност — NIS2 Чл.20(1)",
    "Сеопфатни мерки за безбедност на МИС — ЗБМИС Чл.29",
    "Управување со ризици и безбедносни политики",
    "Пријавување инциденти (ЗБМИС Чл.27): 3ч рано предупредување → 24ч извештај → 72ч почетна проценка → 1 месец финална нотификација",
